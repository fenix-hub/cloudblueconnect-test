# Welcome to Connect Extension project ocr_proj

## Next steps

You may open your favourite IDE and start working with your project, please note that this project runs using docker.
You may modify at any time the credentials used to authenticate to connect modifying the file *ocr_proj/.ocr_proj_dev.env*.
...
```sh
$ docker compose up ocr_proj_dev
```
...
```sh
$ docker compose run ocr_proj_bash
```
...
```sh
$ docker compose run ocr_proj_test
```
